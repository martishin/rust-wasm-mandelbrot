...
const GPURendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gpurenderer_free(ptr >>> 0, 1));
...
export class GPURenderer {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GPURendererFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gpurenderer_free(ptr, 0);
    }
    /**
     ...
     */
    constructor(canvas_id, max_iter) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.gpurenderer_new(ptr0, len0, max_iter);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        GPURendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Call on resize
     ...
     */
    resize(w, h) {
        wasm.gpurenderer_resize(this.__wbg_ptr, w, h);
    }
    /**
     ...
     */
    render(re, im, scale) {
        wasm.gpurenderer_render(this.__wbg_ptr, re, im, scale);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mandelbrot_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
